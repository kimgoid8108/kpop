    ...
    <PageLayout>
      <div className="max-w-5xl mx-auto my-8 md:my-16 px-4 flex flex-col md:flex-row gap-4 md:gap-8">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6 text-gray-900">교육 특성</h1>
          <section className="bg-white rounded-xl shadow p-4 md:p-6 lg:p-8">
            <p className="mb-4 text-lg text-gray-800 leading-relaxed">
              글로벌케이팝진흥원만의 특별한 교육 방식을 소개합니다.
            </p>
            <div className="space-y-6">
              <div className="border-l-4 border-indigo-500 pl-4">
                ...
                <p className="text-gray-700">
                  이론보다 실전 경험을 중시하는 교육 방식으로, 실제 무대와
                  같은 환경에서 학습합니다.
                </p>
              </div>
              <div className="border-l-4 border-indigo-500 pl-4">
                ...
                <p className="text-gray-700">
                  각 수강생의 특성과 수준에 맞춘 개별 지도를 통해 최적의 성장을
                  도모합니다.
                </p>
              </div>
              <div className="border-l-4 border-indigo-500 pl-4">
                ...
                <p className="text-gray-700">
                  전 세계 K-POP 산업과의 네트워크를 활용한 기회 제공과 진로
                  지원을 제공합니다.
                </p>
              </div>
            </div>
