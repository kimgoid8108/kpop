...
const instructors = [
  {
    ...
    spec: [
      ...
      "",
      "아이돌 ‘프리츠’ 백업댄서 활동",
      "SBS 연예대상 <정글의 법칙> 오프닝 댄서",
      "MBC 창사 50주년 특별기획 드라마 <빛과 그림자> 댄서",
      "마술사 최현우 <시크릿 더 매직쇼> 댄서 겸 안무조감독",
      "롯데월드 가든스테이지 마술 공연 안무 겸 감독",
      "브릴란떼 어린이 합창단 키즈 클래스 안무지도",
      "극단 나비애·디얼아이 소속배우 겸 안무총괄",
      "창작어린이뮤지컬 <내 친구 트리트리>,<어.띠.노.두>,<위기탈출 상상나라> 배우 겸 안무감독",
      "창작사극어린이뮤지컬 <글 먹은 범계골 호랑이> 배우 겸 안무감독",
      "",
    ],
  },
  {
  ...
  },
  {
    ...
    field: "dance",
    spec: [
      "TRX STC(suspension taining course)",
      "THERA BAND - clx rehab course",
      "2024~ MUSA & WNGP 심사위원",
      "2024 HADO 댄스피트니스 안무제작",
      "동핏 어깨 부정렬 세미나 수료",
      "킨스트레치 고관절 모빌리티 세미나 수료",
      "운동처방사 1급",
      "2023. 04 내셔널리그 수원 비키니 에이지 3위",
      "2023. 04 내셔널리그 수원 비키니 3위",
      "2023. 10 WNGP 파주 비키니 에이지 그랑프리",
      "2023. 10 WNGP 파주 비키니 오픈 2위",
    ],
  },
  {
    id: "vocal8",
  ...
  },
  {
    ...
    spec: [
      ...
      "윤도현의 러브레터, SBS 인기가요, KBS 뮤직뱅크, MBC 음악 중심 등 출연",
      "예술의 전당 콘서트홀, 세종문화회관 대극장, 이음아트홀 등 행사 및 라이브 클럽 공연",
    ],
  },
  {
    id: "vocal10",
