            ...
            <div className="space-y-4">
              <div className="border rounded-lg p-4">
                ...
                <p className="text-gray-700">
                  현재 수강 중인 모든 수강생의 정보를 확인할 수 있습니다.
                </p>
              </div>
              <div className="border rounded-lg p-4">
                <h2 className="text-xl font-semibold mb-2 text-gray-900">
                ...
                <p className="text-gray-700">
                  수강생들의 평균 진도율과 성적 통계를 확인할 수 있습니다.
                </p>
              </div>
            </div>
          </section>
