...
// ========================
// 3. 이미지가 실제로 "넘어가는" 효과의 오토 스와이프 컴포넌트 (fade 방식)
// ========================
function AutoSwipeImages() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto py-6">
      ...
      >
        {/* Fade 슬라이드 구현: 이미지를 쌓아서, 보여줄 것만 opacity 1로 */}
        <div
      ...
      {/* 슬라이드 안내 문구 */}
      <div className="text-center text-sm text-gray-400 mt-2"></div>
    </div>
  );
}
