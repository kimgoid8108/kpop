            ...
            <div className="space-y-4">
              <div className="border rounded-lg p-4">
                ...
                <p className="text-gray-700">
                  정말 유익한 강의였습니다. 실전 경험이 많은 강사님의 설명이
                  이해하기 쉬웠어요.
                </p>
              </div>
              <div className="border rounded-lg p-4">
                ...
                <p className="text-gray-700">
                  기초부터 차근차근 배울 수 있어서 좋았습니다. 다음 강의도
                  기대됩니다.
                </p>
              </div>
            </div>
