...
export const courses: Course[] = [
  // 담당 강사/수준 정보 없음 (피트니스 강사과정이므로 해당 정보 필요시 추가)
  {
    ...
    content:
      "K-POP댄스 피트니스를 이해하며 안무화 하여 강사로써의 자질을 갖춘다",
    reviews: [
      {
        id: "1",
        author: "김수진",
        rating: 5,
        comment:
          "정말 재미있고 운동도 많이 되네요! 강사님이 친절하시고 설명도 잘 해주셔서 초보자인 저도 쉽게 따라할 수 있었습니다.",
        date: "2024.01.15",
      },
      {
        id: "2",
        ...
        rating: 4,
        comment:
          "K-POP 댄스를 배우면서 체력도 기를 수 있어서 일석이조입니다. 다음 강의도 수강하고 싶어요!",
        date: "2024.01.20",
      },
    ],
    syllabus: [
      ...
      {
        partNumber: 8, // 파트 번호 없이 "중간고사" 단독 섹션 표시
        title: "중간고사",
        lessons: [],
      },
      {
        partNumber: 9,
        title: "K-POP 댄스 피트니스 안무 응용",
        lessons: [
          {
            lessonNumber: 1,
            title: "안무 구성 요소 분석",
          ...
          {
            lessonNumber: 2,
            title: "피트니스에 적용 가능한 동작 분해",
          },
          {
            lessonNumber: 3,
            title: "루틴화 된 K-POP 스타일 피트니스 실습",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            lessonNumber: 2,
            title: "수정 동작, 대체 동작 적용",
          },
          {
            lessonNumber: 3,
            title: "대상자 맞춤 루틴 예시 실습",
          },
        ],
      },
      {
        partNumber: 12,
        title: "K-POP 안무 피트니스 적용 실습",
        lessons: [
          {
            lessonNumber: 1,
            title: "K-POP 스타일 피트니스 안무 실습 1",
          },
          {
            lessonNumber: 2,
            title: "K-POP 스타일 피트니스 안무 실습 2",
          },
          {
            lessonNumber: 3,
            title: "K-POP 스타일 피트니스 안무 실습 3",
          },
        ],
      },
      {
        ...
        lessons: [
          ...
          {
            lessonNumber: 2,
            title: "분석 관점(타이밍, 강도, 움직임)",
          },
          {
            lessonNumber: 3,
            title: "루틴 가능한 안무 기록 실습",
          },
        ],
      },
      {
      ...
      {
        partNumber: 15, // 파트 번호 없이 "중간고사" 단독 섹션 표시
        title: "기말고사",
        lessons: [],
      },
    ],
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "정말 전문적인 강의입니다. 아이돌 무대를 보는 것 같아서 너무 재미있어요!",
        date: "2024.01.10",
      },
    ],
    syllabus: [
    ...
    syllabus: [
      ...
      },
      {
        ...
        lessons: [
          {
            lessonNumber: 1,
            title: "K-POP 기초 동작 1 : 팔 앵글 및 라인 만들기",
          },
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            lessonNumber: 2,
            title: "커버 곡의 퍼포먼스 이해 및 포인트 동작 강화",
          },
        ],
      },
    ],
    ...
    syllabus: [
      {
        ...
        lessons: [
          {
            lessonNumber: 1,
            title: "전신 스트레칭과 k-pop 댄스를 위한 기초 스텝",
          },
    ...
    syllabus: [
      {
        ...
        lessons: [
          { lessonNumber: 1, title: "춤을 배우기 전에 마음가짐 1" },
          { lessonNumber: 2, title: "춤을 배우기 전에 마음가짐 2" },
        ],
      },
      {
        partNumber: 2,
        ...
        lessons: [
          { lessonNumber: 1, title: "웜업과 바운스 1" },
          { lessonNumber: 2, title: "웜업과 바운스 2" },
        ],
      },
      {
        partNumber: 3,
        title: "리듬감 키우기와 팔뻗기",
        lessons: [
          { lessonNumber: 1, title: "리듬감 키우기와 팔뻗기 1" },
          { lessonNumber: 2, title: "리듬감 키우기와 팔뻗기 2" },
        ],
      },
      {
        partNumber: 4,
        title: "몸으로 웨이브하기",
        lessons: [
          { lessonNumber: 1, title: "몸과 팔로 웨이브하기 1" },
          { lessonNumber: 2, title: "몸과 팔로 웨이브하기 2" },
        ],
      },
      {
        partNumber: 5,
        ...
        lessons: [
          { lessonNumber: 1, title: "힙합 댄스의 역사와 스트릿댄스의 종류 1" },
      ...
      },
      {
        ...
        lessons: [
          { lessonNumber: 1, title: "다양한 스텝을 배워요 1" },
  ...
  },
  {
    ...
    syllabus: [
      ...
      },
      {
        ...
        title: "호흡",
        lessons: [
          { lessonNumber: 1, title: "호흡1" },
          { lessonNumber: 2, title: "호흡2" },
          { lessonNumber: 3, title: "호흡3" },
        ],
      },
      {
        partNumber: 5,
        title: "기초발성",
        lessons: [
          { lessonNumber: 1, title: "발성의 종류1" },
          { lessonNumber: 2, title: "발성의 종류2" },
          { lessonNumber: 3, title: "발성의 종류3" },
        ],
      },
      {
        partNumber: 6,
        title: "장르별 발성 1",
        lessons: [
          { lessonNumber: 1, title: "발라드1" },
          { lessonNumber: 2, title: "발라드2" },
          { lessonNumber: 3, title: "발라드3" },
        ],
      },
      {
        partNumber: 7,
        title: "장르별 발성 2",
        lessons: [
          { lessonNumber: 1, title: "락1" },
          { lessonNumber: 2, title: "락2" },
          { lessonNumber: 3, title: "락3" },
        ],
      },
      {
        partNumber: 8,
        title: "장르별 발성 3",
        lessons: [
          { lessonNumber: 1, title: "K-POP 1" },
          { lessonNumber: 2, title: "K-POP 2" },
          { lessonNumber: 3, title: "K-POP 3" },
        ],
      },
      {
        partNumber: 9,
        title: "녹음 테크닉 1",
        lessons: [
          { lessonNumber: 1, title: "녹음이란 1" },
          { lessonNumber: 2, title: "녹음이란 2" },
          { lessonNumber: 3, title: "녹음이란 3" },
        ],
      },
      {
        partNumber: 10,
        title: "녹음 테크닉 2",
        lessons: [
          { lessonNumber: 1, title: "실전녹음 1" },
          { lessonNumber: 2, title: "실전녹음 2" },
          { lessonNumber: 3, title: "실전녹음 3" },
        ],
      },
      {
        partNumber: 11,
        title: "무대 태크닉 1",
        lessons: [
          { lessonNumber: 1, title: "무대란? 1" },
          { lessonNumber: 2, title: "무대란? 2" },
          { lessonNumber: 3, title: "무대란? 3" },
        ],
      },
      {
        partNumber: 12,
        title: "무대 태크닉 2",
        lessons: [
          { lessonNumber: 1, title: "실전무대 1" },
          { lessonNumber: 2, title: "실전무대 2" },
          { lessonNumber: 3, title: "실전무대 3" },
        ],
      },
      {
        partNumber: 13,
        title: "실전 가창기법 1",
        lessons: [
          { lessonNumber: 1, title: "스타일 찾기 1" },
          { lessonNumber: 2, title: "스타일 찾기 2" },
          { lessonNumber: 3, title: "스타일 찾기 3" },
        ],
      },
      {
        partNumber: 14,
        title: "실전 가창기법 2",
        lessons: [
          { lessonNumber: 1, title: "응용 1" },
          { lessonNumber: 2, title: "응용 2" },
          { lessonNumber: 3, title: "응용 3" },
        ],
      },
      {
        partNumber: 15,
        title: "종합정리",
        lessons: [
          { lessonNumber: 1, title: "정리 1" },
          { lessonNumber: 2, title: "정리 2" },
          { lessonNumber: 3, title: "정리 3" },
        ],
      },
    ],
    instructor: "박래준",
    ...
    syllabus: [
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            lessonNumber: 2,
            title: "K-POP 커버 댄스 연습 (느리게, 원래 속도)",
          },
        ],
      },
    ],
    ...
    syllabus: [
      {
        ...
        title: "음악이란 무엇인가",
        lessons: [
          { lessonNumber: 1, title: "음악의 구성" },
          { lessonNumber: 2, title: "음악과 세상의 소통 1" },
          { lessonNumber: 3, title: "음악과 세상의 소통 2" },
        ],
      },
      {
        partNumber: 2,
        title: "음악과 매칭",
        lessons: [
          { lessonNumber: 1, title: "작곡가의 의도와 음악의 매칭" },
          { lessonNumber: 2, title: "한국 가요와 K-POP의 차이에 대하여" },
          { lessonNumber: 3, title: "녹음실과 작업실의 차이에 대하여" },
        ],
      },
      {
        partNumber: 3,
        title: "시퀀싱 프로그램(DAW)",
        lessons: [
          { lessonNumber: 1, title: "Logic Pro 1" },
          { lessonNumber: 2, title: "Logic Pro 2" },
          { lessonNumber: 3, title: "Logic Pro 3" },
        ],
      },
      {
        partNumber: 4,
        title: "보컬에 관하여",
        lessons: [
          { lessonNumber: 1, title: "노래(보컬)란 무엇인가" },
          { lessonNumber: 2, title: "음악 세대별 생각하는 발성의 정의" },
          { lessonNumber: 3, title: "보컬의 개성과 테크닉의 차이" },
        ],
      },
      {
        partNumber: 5,
        title: "리듬 파트에 관하여",
        lessons: [
          { lessonNumber: 1, title: "리듬 앤 베이스" },
          { lessonNumber: 2, title: "리얼 드럼과 미디 드럼" },
          { lessonNumber: 3, title: "퍼커션의 역할에 대하여" },
        ],
      },
      {
        partNumber: 6,
        title: "리얼 드럼에 대하여",
        lessons: [
          { lessonNumber: 1, title: "오버헤드와 블리딩" },
          { lessonNumber: 2, title: "리얼 악기와 가상 악기 1" },
          { lessonNumber: 3, title: "리얼 악기와 가상 악기 2" },
        ],
      },
      {
        partNumber: 7,
        title: "건반 악기에 대하여",
        lessons: [
          { lessonNumber: 1, title: "편곡에서 건반 악기의 역할" },
          { lessonNumber: 2, title: "아르페지오와 리듬(블록)" },
          { lessonNumber: 3, title: "건반에서 중저음의 의미" },
        ],
      },
      {
        partNumber: 8,
      ...
      },
      {
        ...
        title: "신디사이저에 대하여",
        lessons: [
          { lessonNumber: 1, title: "신디사이저 악기의 모듈" },
          { lessonNumber: 2, title: "리얼 신스와 가상악기 신스" },
          { lessonNumber: 3, title: "Filter와 Lfo에 관하여" },
        ],
      },
      {
        partNumber: 10,
        title: "현악기(String)에 대해",
        lessons: [
          { lessonNumber: 1, title: "String 악기의 종류와 역할" },
          { lessonNumber: 2, title: "리얼과 가상 악기" },
          { lessonNumber: 3, title: "레가토, 스피카토, 트레몰로, 피치카토" },
        ],
      },
      {
        partNumber: 11,
        title: "브라스(Horn)에 대해",
        lessons: [
          { lessonNumber: 1, title: "브라스 악기의 종류와 역할" },
          { lessonNumber: 2, title: "현악기와 브라스 악기의 차이" },
          { lessonNumber: 3, title: "디스코와 펑키, 라틴" },
        ],
      },
      {
        partNumber: 12,
        title: "녹음에 대하여",
        lessons: [
          { lessonNumber: 1, title: "앨범 제작 과정에서 녹음의 의미" },
          { lessonNumber: 2, title: "녹음시 사용되는 장비와 프로그램" },
          { lessonNumber: 3, title: "보컬 녹음시 모니터링에 대하여" },
        ],
      },
      {
        partNumber: 13,
        title: "레코딩 디렉팅에 대하여",
        lessons: [
          { lessonNumber: 1, title: "레코딩 디렉팅이란 무엇인가" },
          { lessonNumber: 2, title: "녹음시 보컬의 애티튜드에 대하여" },
          { lessonNumber: 3, title: "컴프레서, 이퀄라이저, 리버브, 디레이" },
        ],
      },
      {
        partNumber: 14,
        title: "믹싱과 마스터링",
        lessons: [
          { lessonNumber: 1, title: "데모곡의 믹싱과 마스터링" },
          { lessonNumber: 2, title: "앨범 제작시 믹싱과 마스터링" },
          { lessonNumber: 3, title: "뮤비 사운드와 앨범 사운드" },
        ],
      },
      {
        partNumber: 15,
