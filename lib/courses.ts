...
- 나만의 멋진 무대를 만들어 자신감을 뿜뿜 키워봐요.`,
  ...
  },
  {
    ...
    categoryEn: "Music",
    title: "보컬 마스터 강사과정",
    intro: `보컬 교육 전문가를 양성하는 종합 강사 과정입니다. 발성 기법, 음악 이론, 교육 방법론을 체계적으로 학습하여 전문 보컬 강사로 성장할 수 있습니다.`,
    content: `- 보컬 교육의 이론과 실기를 종합적으로 습득합니다.
- 다양한 연령대와 수준에 맞는 교육 방법을 학습합니다.
- 실제 교육 현장에서 활용 가능한 실전 노하우를 익힙니다.
- 음악 교육 커리큘럼 기획 및 운영 능력을 기릅니다.`,
    reviews: [],
    syllabus: [
      {
        partNumber: 1,
        title: "보컬 교육 기초 이론",
        lessons: [
          { lessonNumber: 1, title: "보컬 교육의 이해" },
          { lessonNumber: 2, title: "음악 교육 철학" },
          { lessonNumber: 3, title: "학습자 분석 및 맞춤 교육" },
        ],
      },
      {
        partNumber: 2,
        title: "발성 및 호흡 기법",
        lessons: [
          { lessonNumber: 1, title: "올바른 호흡법" },
          { lessonNumber: 2, title: "발성 원리와 실습" },
          { lessonNumber: 3, title: "공명과 음색 조절" },
        ],
      },
      {
        partNumber: 3,
        title: "음악 이론 및 실기",
        lessons: [
          { lessonNumber: 1, title: "음정, 리듬, 화성 이해" },
          { lessonNumber: 2, title: "장르별 보컬 기법" },
          { lessonNumber: 3, title: "실전 가창 연습" },
        ],
      },
    ],
    instructor: "이수진",
  ...
  },
  {
    ...
    intro: `K-POP 스타일의 보컬 트레이닝 전문가를 양성하는 과정입니다. K-POP 특유의 보컬 스타일과 표현 기법을 마스터하고, 이를 교육할 수 있는 전문 강사로 성장합니다.`,
    content: `- K-POP 보컬의 특징과 스타일을 이해합니다.
- K-POP 장르별 보컬 기법을 습득합니다.
- 보컬 트레이닝 프로그램을 기획하고 운영합니다.
- 실전 무대 경험과 교육 역량을 동시에 기릅니다.`,
    reviews: [],
    syllabus: [
      {
        partNumber: 1,
        title: "K-POP 보컬 기초",
        lessons: [
          { lessonNumber: 1, title: "K-POP 보컬의 특징" },
          { lessonNumber: 2, title: "K-POP 스타일 분석" },
          { lessonNumber: 3, title: "기본 보컬 테크닉" },
        ],
      },
      {
        partNumber: 2,
        title: "고급 보컬 기법",
        lessons: [
          { lessonNumber: 1, title: "믹스 보이스와 벨팅" },
          { lessonNumber: 2, title: "감정 표현과 퍼포먼스" },
          { lessonNumber: 3, title: "무대 매너와 스타일링" },
        ],
      },
    ],
    instructor: "정민아",
  ...
  },
  {
    ...
    categoryEn: "Music",
    title: "K-POP 하모니 앙상블",
    intro: `중학생을 위한 K-POP 하모니와 앙상블 수업입니다. 친구들과 함께 K-POP 곡을 하모니로 완성하며 협업 능력과 음악적 감성을 키웁니다.`,
    content: `- 하모니의 기본 원리를 이해하고 실습합니다.
- 팀워크를 통한 앙상블 연주를 경험합니다.
- K-POP 곡을 하모니로 편곡하고 완성합니다.
- 무대 공연을 통해 자신감과 표현력을 기릅니다.`,
    reviews: [],
    syllabus: [
      {
        partNumber: 1,
        title: "하모니 기초",
        lessons: [
          { lessonNumber: 1, title: "화음의 이해" },
          { lessonNumber: 2, title: "기본 하모니 연습" },
        ],
      },
      {
        partNumber: 2,
        title: "앙상블 실습",
        lessons: [
          { lessonNumber: 1, title: "파트 분담과 연습" },
          { lessonNumber: 2, title: "합창 연습" },
        ],
      },
      {
        partNumber: 3,
        title: "K-POP 하모니 완성",
        lessons: [
          { lessonNumber: 1, title: "K-POP 곡 하모니 편곡" },
          { lessonNumber: 2, title: "무대 공연 준비" },
        ],
      },
    ],
    instructor: "최지영",
  ...
  },
  {
    ...
    categoryEn: "Music",
    title: "즐거운 리듬 놀이 음악",
    intro: `초등학생을 위한 재미있는 리듬과 음악 놀이 수업입니다. 음악을 게임처럼 즐기며 자연스럽게 리듬감과 음감을 기릅니다.`,
    content: `- 리듬 게임과 놀이를 통해 음악을 즐깁니다.
- 간단한 악기 연주를 배워봅니다.
- 친구들과 함께 음악 활동을 합니다.
- 음악에 대한 흥미와 자신감을 키웁니다.`,
    reviews: [],
    syllabus: [
      {
        partNumber: 1,
        title: "리듬 놀이",
        lessons: [
          { lessonNumber: 1, title: "리듬 게임하기" },
          { lessonNumber: 2, title: "박수로 리듬 표현하기" },
        ],
      },
      {
        partNumber: 2,
        title: "악기 체험",
        lessons: [
          { lessonNumber: 1, title: "간단한 악기 연주하기" },
          { lessonNumber: 2, title: "친구들과 함께 연주하기" },
        ],
      },
      {
        partNumber: 3,
        title: "음악 만들기",
        lessons: [
          { lessonNumber: 1, title: "우리만의 리듬 만들기" },
          { lessonNumber: 2, title: "음악 발표회" },
        ],
      },
    ],
    instructor: "박서연",
